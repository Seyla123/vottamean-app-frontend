...
const AttendanceTable = ({
    ...
    const PdfDownloadContent = ({
        ...
        const studentChunks = studentLimit ? chunkArray(students, studentLimit) : chunkArray(students, students?.length);
        const dateChunks = dateLimit ? chunkArray(dates, dateLimit) : chunkArray(dates, dates?.length);
